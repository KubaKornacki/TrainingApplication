...
namespace App_v2.Areas.Identity.Pages.Account.Manage
{
    public partial class IndexModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (!setResult.Succeeded)
            {
                ...
                throw new InvalidOperationException($"Wystąpił błąd podczas aktualizacji profilu");
            }
            ...
            StatusMessage = "Zaktualizwano profil";
